...
import (
	"cmp" // renamed to avoid conflict with utils/json
	"errors"
	"fmt"
	"net/http"
	...
	"github.com/cryft-labs/cryftgo/utils/json" // provides json.Uint64, json.Uint32, etc.
...
// NOTE: Pin-requirement types and GetPinRequirements now live in
// pin_requirements.go. The duplicates in this file have been removed to avoid
